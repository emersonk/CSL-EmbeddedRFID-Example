...
#define __FREQTABLE_H__
        ...
        unsigned int indonesiaFreqTable[] =
        {
            0x00180E6D, /*923.25 MHz    */
            0x00180E6F,/*923.75 MHz    */
            0x00180E71,/*924.25 MHz    */
...
#define NUM_COUNTRIES		28

struct{
	const unsigned int const *freq_table;
	int freq_count;
}
countryFreqTable[NUM_COUNTRIES] = 
{
...
const char *CountryTxt[NUM_COUNTRIES] =
{
	"FCC",
	"ETSI",
	"IN",
